...
class GameUiAssets: 
	...
	# description 
	I_MAIN_GOTO_MALL = RuleImage(roi_front=(620,590,33,35), roi_back=(620,590,120,100), threshold=0.7, method="Template matching", file="./tasks/GameUi/page/page_main_goto_mall.png")
	# description 
