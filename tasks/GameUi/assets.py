...
class GameUiAssets: 
	...
	# 进入花合战 
	I_MAIN_GOTO_DAILY = RuleImage(roi_front=(735,590,33,35), roi_back=(735,590,120,100), threshold=0.6, method="Template matching", file="./tasks/GameUi/page/page_main_goto_daily.png")
	# description 
	...
	# description 
	I_CHECK_FRIENDS = RuleImage(roi_front=(67,625,70,72), roi_back=(67,625,70,72), threshold=0.9, method="Template matching", file="./tasks/GameUi/page/page_check_friends.png")
	# description 
